...
extern "C"
{
	...
	SE_DLL_API void RM_SetAlignMode(int id, int mode)
	{
		if (player != nullptr)
		{
			if (id < static_cast<int>(player->scenarioEngine->entities_.object_.size()))
			{
				player->scenarioEngine->entities_.object_[static_cast<unsigned int>(id)]->pos_.SetAlignMode((roadmanager::Position::ALIGN_MODE)mode);
			}
		}
	}
	...
	SE_DLL_API void RM_SetAlignModeH(int id, int mode)
	{
		if (player != nullptr)
		{
			if (id < static_cast<int>(player->scenarioEngine->entities_.object_.size()))
			{
				player->scenarioEngine->entities_.object_[static_cast<unsigned int>(id)]->pos_.SetAlignModeH((roadmanager::Position::ALIGN_MODE)mode);
			}
		}
	}
	...
	SE_DLL_API void RM_SetAlignModeP(int id, int mode)
	{
		if (player != nullptr)
		{
			if (id < static_cast<int>(player->scenarioEngine->entities_.object_.size()))
			{
				player->scenarioEngine->entities_.object_[static_cast<unsigned int>(id)]->pos_.SetAlignModeP((roadmanager::Position::ALIGN_MODE)mode);
			}
		}
	}
	...
	SE_DLL_API void RM_SetAlignModeR(int id, int mode)
	{
		if (player != nullptr)
		{
			if (id < static_cast<int>(player->scenarioEngine->entities_.object_.size()))
			{
				player->scenarioEngine->entities_.object_[static_cast<unsigned int>(id)]->pos_.SetAlignModeR((roadmanager::Position::ALIGN_MODE)mode);
			}
		}
	}
	...
	SE_DLL_API void RM_SetAlignModeZ(int id, int mode)
	{
		if (player!= nullptr)
		{
			if (id < static_cast<int>(player->scenarioEngine->entities_.object_.size()))
			{
				player->scenarioEngine->entities_.object_[static_cast<unsigned int>(id)]->pos_.SetAlignModeZ((roadmanager::Position::ALIGN_MODE)mode);
			}
		}
	}
